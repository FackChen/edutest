	...
	<div id="win" class="easyui-window" title="客户数据编辑" style="width:300px;height:250px;top:100px"   
	    ...
	    <form id="editForm" method="post">
	    	...
	    	<input type="hidden" name="id">
		  	...
		  	编号:<input type="text" name="number" class="easyui-validatebox" data-options="required:true" style="margin-left:39px"/><br/>
    	...
    	//列表
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				$("#editForm").form("load","teacher/findById.action?id="+rows[0].id);
  			...
  			$("#btn_delete").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
  						...
  						$.post("teacher/delete.action",idStr,function(data){
  							if(data.success){
  	  							$("#list").datagrid("reload");
